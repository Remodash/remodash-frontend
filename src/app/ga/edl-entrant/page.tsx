...
const EDLEntrantPage = () => {
        ...
        corps_etat: [
          {
            nom: "CHAUFFAGE",
            composants: [
              { nom: "RADIATEUR", etat: "BON ÉTAT" },
              { nom: "ROBINET THERMOSTATIQUE", etat: "BON ÉTAT" }
            ]
          },
          {
            nom: "ELEC",
            composants: [
              { nom: "APPLIQUE", etat: "BON ÉTAT" },
              { nom: "CABLE", etat: "BON ÉTAT" },
              { nom: "CACHE PRISE", etat: "BON ÉTAT" },
              { nom: "DOUILLE", etat: "BON ÉTAT" },
              { nom: "INTERRUPTEUR", etat: "BON ÉTAT" },
              { nom: "MOULURE", etat: "BON ÉTAT" },
              { nom: "PRISE ELECTRIQUE", etat: "BON ÉTAT" }
            ]
          },
          {
            nom: "MENUISERIE/SERRURERIE",
            composants: [
              { nom: "FENETRE", etat: "BON ÉTAT" },
              { nom: "PLINTHE", etat: "BON ÉTAT" },
              { nom: "POIGNEE", etat: "BON ÉTAT" },
              { nom: "PORTE INTERIEURE", etat: "BON ÉTAT" },
              { nom: "RIVE BLOC", etat: "BON ÉTAT" },
              { nom: "VITRAGE", etat: "BON ÉTAT" }
            ]
          },
          {
            nom: "PEINTURE",
            composants: [
              { nom: "DALLES PVC", etat: "BON ÉTAT" },
              { nom: "FAIENCE", etat: "BON ÉTAT" },
              { nom: "PEINTURE", etat: "BON ÉTAT" },
              { nom: "PLAFOND", etat: "BON ÉTAT" }
            ]
          },
          {
            nom: "PLOMBERIE",
            composants: [
              { nom: "EVIER", etat: "BON ÉTAT" },
              { nom: "MEUBLE SOUS EVIER", etat: "BON ÉTAT" },
              { nom: "ROBINETTERIE", etat: "BON ÉTAT" },
              { nom: "VIDANGE", etat: "BON ÉTAT" },
              { nom: "VMC", etat: "BON ÉTAT" }
            ]
          }
        ]
      },
        ...
        corps_etat: [
          ...
          },
          {
            ...
            composants: [
              ...
              { nom: "PORTE INTERIEURE", etat: "BON ÉTAT" },
              { nom: "RIVE BLOC", etat: "BON ÉTAT" },
              { nom: "SERRURE", etat: "BON ÉTAT" },
              { nom: "VERROU", etat: "BON ÉTAT" }
            ]
          },
          {
            nom: "PEINTURE",
          ...
          },
          {
            nom: "PLOMBERIE",
            composants: [
              { nom: "BAIGNOIRE", etat: "BON ÉTAT" },
              { nom: "LAVABO", etat: "BON ÉTAT" },
              { nom: "ROBINETTERIE", etat: "BON ÉTAT" },
              { nom: "VIDANGE", etat: "BON ÉTAT" },
              { nom: "VMC", etat: "BON ÉTAT" },
              { nom: "WC", etat: "BON ÉTAT" }
            ]
          }
        ]
      },
        ...
        corps_etat: [
          ...
          },
          {
            ...
            composants: [
              ...
              { nom: "MOULURE", etat: "BON ÉTAT" },
              { nom: "PRISE ELECTRIQUE", etat: "BON ÉTAT" },
              { nom: "PRISE TV TELEPHONE INTERNET", etat: "BON ÉTAT" }
            ]
          },
          {
            nom: "MENUISERIE/SERRURERIE",
            composants: [
              { nom: "FENETRE", etat: "BON ÉTAT" },
              { nom: "GRILLE AERATION", etat: "BON ÉTAT" },
              { nom: "MANIVELLE SANGLE VOLET", etat: "BON ÉTAT" },
              { nom: "PLINTHE", etat: "BON ÉTAT" },
              { nom: "POIGNEE", etat: "BON ÉTAT" },
              { nom: "PORTE INTERIEURE", etat: "BON ÉTAT" },
              { nom: "RIVE BLOC", etat: "BON ÉTAT" },
              { nom: "SERRURE", etat: "BON ÉTAT" },
              { nom: "VITRAGE", etat: "BON ÉTAT" },
              { nom: "VOLETS", etat: "BON ÉTAT" }
            ]
          },
          {
            nom: "PEINTURE",
            composants: [
              { nom: "PAPIER PEINT", etat: "MAUVAIS ÉTAT", observations: "décolle" },
              { nom: "PARQUET", etat: "BON ÉTAT" },
              { nom: "PLAFOND", etat: "BON ÉTAT" }
            ]
          }
        ]
      ...
      chambre_2: {
        corps_etat: [
          ...
          },
          {
            nom: "PEINTURE",
            composants: [
              { nom: "PAPIER PEINT", etat: "BON ÉTAT" },
              { nom: "PARQUET", etat: "BON ÉTAT" },
              { nom: "PEINTURE", etat: "BON ÉTAT" },
              { nom: "PLAFOND", etat: "BON ÉTAT" }
            ]
      ...
      salle_de_sejour: {
        corps_etat: [
          ...
          },
          {
            ...
            composants: [
              { nom: "PORTE ALVEOLAIRE", etat: "BON ÉTAT" },
              { nom: "PORTE FENETRE", etat: "BON ÉTAT" },
              { nom: "VOLET ROULANT", etat: "BON ÉTAT" }
            ]
          },
          {
            nom: "PEINTURE",
          ...
          },
          {
            ...
            composants: [
              { nom: "REVETEMENTS SOLS", etat: "BON ÉTAT" }
            ]
          }
        ]
      },
        ...
        corps_etat: [
          {
            ...
            composants: [
              { nom: "PLINTHE", etat: "BON ÉTAT" },
              { nom: "POIGNEE", etat: "BON ÉTAT" },
              { nom: "PORTE PLACARD", etat: "BON ÉTAT" }
            ]
          },
          {
            nom: "PEINTURE",
            composants: [
              { nom: "LINOS", etat: "BON ÉTAT" },
              { nom: "PAPIER PEINT", etat: "BON ÉTAT" },
              { nom: "PLAFOND", etat: "BON ÉTAT" }
            ]
          }
        ...
        corps_etat: [
          {
            ...
            composants: [
              { nom: "CABLE", etat: "BON ÉTAT" },
              { nom: "CACHE PRISE", etat: "BON ÉTAT" },
              { nom: "COMBINET INTERPHONE", etat: "BON ÉTAT" },
              { nom: "DOUILLE", etat: "BON ÉTAT" },
              { nom: "INTERRUPTEUR", etat: "BON ÉTAT" },
              { nom: "MOULURE", etat: "BON ÉTAT" },
              { nom: "PRISE ELECTRIQUE", etat: "BON ÉTAT" },
              { nom: "SONNETTE", etat: "BON ÉTAT" },
              { nom: "TABLEAU", etat: "BON ÉTAT" }
            ]
          },
          {
            nom: "MENUISERIE INTERIEURE",
            composants: [
              { nom: "PORTE PALIERE/ENTREE", etat: "BON ÉTAT" }
            ]
          },
          {
            nom: "MENUISERIE/SERRURERIE",
            composants: [
              { nom: "ENTREBAILLEUR", etat: "BON ÉTAT" },
              { nom: "JUDAS", etat: "BON ÉTAT" },
              { nom: "PLINTHE", etat: "BON ÉTAT" },
              { nom: "POIGNEE", etat: "BON ÉTAT" },
              { nom: "RIVE BLOC", etat: "BON ÉTAT" },
              { nom: "SERRURE", etat: "BON ÉTAT" },
        ...
        corps_etat: [
          {
            ...
            composants: [
              { nom: "GARDE CORPS", etat: "BON ÉTAT" },
              { nom: "MACONNERIE", etat: "BON ÉTAT" },
              { nom: "REVET SOL", etat: "BON ÉTAT" }
            ]
          }
        ]
      }
  ...
  const tenants: Tenant[] = [
    {
      ...
      email: "ndeye.thiam@example.com",
      currentAddress: "6 SQUARE ESQUIROL, 94000 CRETEIL",
      newAddress: "12 AVENUE DE LA REPUBLIQUE, 75011 PARIS",
    ...
    },
    {
      ...
      currentAddress: "3 RUE DU COMMERCE, 93200 SAINT-DENIS",
      newAddress: "10 RUE DE LA PAIX, 93200 SAINT-DENIS",
    ...
    },
    {
      ...
      currentAddress: "8 BIS RUE DE VERDUN, 94120 FONTENAY",
      newAddress: "5 AVENUE GAMBETTA, 94120 FONTENAY",
    ...
    },
    {
      ...
      currentAddress: "14 ALLEE DES CHATAIGNIERS, 94300 VINCENNES",
      newAddress: "22 BOULEVARD DE STRASBOURG, 94300 VINCENNES",
  ...
  const openModal = (tenant: Tenant) => {
    ...
    // Initialiser les données du formulaire avec les valeurs du locataire
    setFormData({
      ...initialData,
      locataire: {
      ...
      informations_generales: {
        ...
        contrat: tenant.property.type,
        logement: `${tenant.property.building} - ${tenant.property.floor} - Porte ${tenant.property.doorNumber}`,
  ...
  const handleComponentStateChange = (room: string, corpsEtatIndex: number, componentIndex: number, etat: 'BON ÉTAT' | 'MAUVAIS ÉTAT') => {
  ...
  const filteredTenants = tenants.filter(tenant => {
    ...
    if (searchTerm) {
      ...
      return (
        ...
        tenant.property.building.toLowerCase().includes(term)
      );
    }
              ...
              <div className="flex items-center justify-between">
                <div className="min-w-0">
                  <h2 className="text-xl sm:text-2xl font-bold text-gray-900 dark:text-neutral-200 truncate">
                    État des Lieux Entrant - {formData.informations_generales.numero_edl}
                  </h2>
                                    ...
                                    <div key={`${room}-${corpsEtat.nom}-${composant.nom}`} className="space-y-1">
                                      <div className="flex items-center justify-between">
                                        ...
                                        <div className="flex items-center gap-2">
                                          <button
                                            onClick={() => handleComponentStateChange(room, corpsEtatIndex, componentIndex, 'BON ÉTAT')}
                                            className={`p-1 rounded ${composant.etat === 'BON ÉTAT' ? 'bg-green-100 text-green-800 dark:bg-green-900 dark:text-green-200' : 'bg-gray-100 text-gray-500 dark:bg-neutral-700 dark:text-neutral-400'}`}
                                            title="Bon état"
                                          >
                                            <Check className="w-3 h-3" />
                                          </button>
                                          <button
                                            onClick={() => handleComponentStateChange(room, corpsEtatIndex, componentIndex, 'MAUVAIS ÉTAT')}
                                            className={`p-1 rounded ${composant.etat === 'MAUVAIS ÉTAT' ? 'bg-red-100 text-red-800 dark:bg-red-900 dark:text-red-200' : 'bg-gray-100 text-gray-500 dark:bg-neutral-700 dark:text-neutral-400'}`}
                                            title="Mauvais état"
                                          >
